...
RESTAURANT_SEATS = 10
RESTAURANT_STAFF = 2
RESTAURANT_VISIT_CHANCE = 0.28
RESTAURANT_TIME_MIN = 0.8
RESTAURANT_TIME_MAX = 1.4


# APRES-SKI

APRES_SKI_CAPACITY = 12
APRES_SKI_VISIT_CHANCE = 0.22
APRES_SKI_TIME_MIN = 0.5
APRES_SKI_TIME_MAX = 1.0
