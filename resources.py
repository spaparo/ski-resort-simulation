...
def _service_multiplier(visitor):
    return PEAK_SERVICE_SLOWDOWN_FACTOR if getattr(visitor, "is_peak_arrival", False) else 1.0
...
class RentalShop:
    ...
    def rent_equipment(self, visitor):
        ...
        service_time = random.uniform(RENTAL_TIME_MIN, RENTAL_TIME_MAX) * _service_multiplier(visitor)
...
class LiftStation:
    ...
    def use_lift(self, visitor):
        ...
        ride_time = random.uniform(LIFT_RIDE_TIME_MIN, LIFT_RIDE_TIME_MAX) * _service_multiplier(visitor)
...
class Cafe:
    ...
    def visit(self, visitor):
        ...
        service_time = random.uniform(CAFE_TIME_MIN, CAFE_TIME_MAX) * _service_multiplier(visitor)
        time.sleep(service_time)
...
class Slope:
    ...
    def go_down(self, visitor):
        ...
        run_time = random.uniform(SLOPE_TIME_MIN, SLOPE_TIME_MAX) * _service_multiplier(visitor)
        time.sleep(run_time)
